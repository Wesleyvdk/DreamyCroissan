export default function PP() {
  return (
    <p>
      <h1 className="mb-5">PRIVACY NOTICE</h1>
      <p className="mb-5">Last updated 1/22/2024 </p>
      <p className="mb-5">
        This privacy notice for Elysevo(&quot;we,&quot; &quot;us,&quot; or
      ...
      <h2 className="mb-5">SUMMARY OF KEY POINTS</h2>
      <p className="mb-5">
      ...
      <p className="mb-5">Personal information you disclose to us</p>
      <p className="mb-5">
      ...
      <p className="mb-5">Information automatically collected</p>
      <p className="mb-5">
      ...
      <h2 className="mb-5">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
      <p className="mb-5">
      ...
      <p className="mb-5">
        Our servers are located in Frankfurt. If you are accessing our Services
        ...
        AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?&quot; above), in
        and other countries.
      </p>
      <p className="mb-5">
      ...
      <h2 className="mb-5">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
      <p className="mb-5">
        If you have questions or comments about this notice, you may contact us
        by post at <span className="bold">ehzgodd@aylanibot.app</span>
      </p>
    </p>
  );
}
