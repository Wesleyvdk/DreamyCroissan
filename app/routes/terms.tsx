...
export default function ToS() {
  return (
    <div>
      ...
      <p className="mb-5">Last updated January 22, 2024</p>
      <h2 className="mb-5">AGREEMENT TO OUR LEGAL TERMS</h2>
      <p className="mb-5">
        We are Elysevo (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or
        &quot;our&quot;), an unregistered company.
      </p>
      <p className="mb-5">
        We operate the website{" "}
        <span className="bold">https://teamserene-auth.vercel.app</span>
      ...
      <p className="mb-5">
        ...
        <span className="bold">ehzgodd@aylanibot.app</span>.
      </p>
      <p className="mb-5">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (&apos;you&apos;), and
        Elysevo, concerning your access to and use of the Services. You agree
      ...
      <ul className="mb-5">
        ...
        <li>
          <Link to="#">4. PROHIBITED ACTIVITIES</Link>
        </li>
        <li>
          <Link to="#">5. USER GENERATED CONTRIBUTIONS</Link>
        </li>
        <li>
          <Link to="#">6. CONTRIBUTION LICENCE</Link>
        </li>
        <li>
          <Link to="#">7. THIRD-PARTY WEBSITES AND CONTENT</Link>
        </li>
        <li>
          <Link to="#">8. SERVICES MANAGEMENT</Link>
        </li>
        <li>
          <Link to="#">9. PRIVACY POLICY</Link>
        </li>
        <li>
          <Link to="#">10. TERM AND TERMINATION</Link>
        </li>
        <li>
          <Link to="#">11. MODIFICATIONS AND INTERRUPTIONS</Link>
        </li>
        <li>
          <Link to="#">12. GOVERNING LAW</Link>
        </li>
        <li>
          <Link to="#">13. DISPUTE RESOLUTION</Link>
        </li>
        <li>
          <Link to="#">14. CORRECTIONS</Link>
        </li>
        <li>
          <Link to="#">15. DISCLAIMER</Link>
        </li>
        <li>
          <Link to="#">16. LIMITATIONS OF LIABILITY</Link>
        </li>
        <li>
          <Link to="#">17. INDEMNIFICATION</Link>
        </li>
        <li>
          <Link to="#">18. USER DATA</Link>
        </li>
        <li>
          <Link to="#">
      ...
      <h2 className="mb-5">1. OUR SERVICES</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">2.INTELLECTUAL PROPERTY RIGHTS</h2>
      <p className="mb-5">
        Our intellectual property We are the owner or the licensee of all
        intellectual property rights in our Services, including all source span
        className="bold", databases, functionality, software, website designs,
        audio, video, p, photographs, and graphics in the Services
        (collectively, the &apos;Content&apos;), as well as the trademarks,
        service marks, and logos contained therein (the &apos;Marks&apos;). Our
        ...
        personal, non-commercial use or internal business purpose only. Your use
        ...
        republished, uploaded, posted, publicly displayed, enspan
        className="bold"d, translated, transmitted, distributed, sold, licensed,
        or otherwise exploited for any commercial purpose whatsoever, without
        our express prior written permission. If you wish to make any use of the
        ...
        ehzgodzd@aylani.bot.app. If we ever grant you the permission to post,
        ...
        visible on posting, reproducing, or displaying our Content. We reserve
        all rights not expressly granted to you in and to the Services, Content,
        and Marks. Any breach of these Intellectual Property Rights will
        constitute a material breach of our Legal Terms and your right to use
        our Services will terminate immediately. Your submissions Please review
        this section and the &apos;PROHIBITED ACTIVITIES&apos; section carefully
        ...
        licences to submit such Submissions and that you have full authority to
      ...
      <h2 className="mb-5">3. USER REPRESENTATIONS</h2>
      <p className="mb-5">
        ...
        for any illegal or unauthorised purpose; and(5) your use of the Services
      ...
      <h2 className="mb-5">4. PROHIBITED ACTIVITIES</h2>
      <p className="mb-5">
        ...
        specifically endorsed or approved by us.The Services may not be used in
        connection with any commercial endeavours except those that are
      ...
      <ul>
        ...
        <li>
          ...
          the Services and / or the Content housed therein.
        </li>
        <li>
        ...
        <li>
          ...
          letters and spamming(continuous posting of repetitive p), that
        ...
        <li>
          ...
          to Flash, PHP, HTML, JavaScript, or other span className="bold".
        </li>
        <li>
          Except as permitted by applicable law, decipher, decompile, reverse
      ...
      <h2 className="mb-5">5. USER GENERATED CONTRIBUTIONS</h2>
      <p className="mb-5">
        The Services does not offer users to submit or post content. We may
        provide you with the opportunity to create, submit, post, display,
        transmit, perform, publish, distribute, or broadcast content and
        materials to us or on the Services, including but not limited to p,
      ...
      <h2 className="mb-5">6. CONTRIBUTION LICENCE</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">7. THIRD-PARTY WEBSITES AND CONTENT</h2>
      <p className="mb-5">
        The Services may contain (or you may be sent via the Site) links to
        other websites (&quot;Third-Party Websites&quot;) as well as articles,
        photographs, p, graphics, pictures, designs, music, sound, video,
      ...
      <h2 className="mb-5">8. SERVICES MANAGEMENT</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">9. PRIVACY POLICY</h2>
      <p className="mb-5">
        ...
        hosted in the Netherlands and United States. If you access the Services
        ...
        applicable laws in the Netherlands and United States, then through your
        continued use of the Services, you are transferring your data to the
        Netherlands and United States, and you expressly consent to have your
        data transferred to and processed in the Netherlands and United States.
      </p>
      <h2 className="mb-5">10. TERM AND TERMINATION</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">11. MODIFICATIONS AND INTERRUPTIONS</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">12. GOVERNING LAW</h2>
      <p className="mb-5">
        ...
        provisions of the law in your country to residence. Elysevo and yourself
        both agree to submit to the non-exclusive jurisdiction of the courts of
        Noord Brabant, which means that you may make a claim to defend your
        consumer protection rights in regards to these Legal Terms in the
        Netherlands , or in the EU country in which you reside.
      </p>
      <h2 className="mb-5">13. DISPUTE RESOLUTION</h2>
      <p className="mb-5">
        Binding Arbitration Any dispute arising from the relationships between
        the Parties to these Legal Terms shall be determined by one arbitrator
        who will be chosen in accordance with the Arbitration and Internal Rules
        of the European Court of Arbitration being part of the European Centre
        of Arbitration having its seat in Strasbourg, and which are in force at
        the time the application for arbitration is filed, and of which adoption
        of this clause constitutes acceptance. The seat of arbitration shall be
        Amsterdam, Netherlands. The language of the proceedings shall be
        English. Applicable rules of substantive law shall be the law of the
        Netherlands. Restrictions The Parties agree that any arbitration shall
        ...
        allegations of theft, piracy, invasion of privacy, or unauthorised use;
        ...
        competent jurisdiction within the courts uled for jurisdiction above,
        and the Parties agree to submit to the personal jurisdiction of that
        court.
      </p>
      <h2 className="mb-5">14. CORRECTIONS</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">15. DISCLAIMER</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">16. LIMITATIONS OF LIABILITY</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">17. INDEMNIFICATION</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">18. USER DATA</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">20. MISCELLANEOUS</h2>
      <p className="mb-5">
      ...
      <h2 className="mb-5">21. CONTACT US</h2>
      <p className="mb-5">
